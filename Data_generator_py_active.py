...
import example_pendulum_active
...
def image_process(sample_size,params):
    sample_size = 10
    data = example_pendulum_active.get_pendulum_data(sample_size,params)
    image = data['x']
    ...
    for i in range(image.shape[0]-2):
        ...
        angle_t[i] = temp
    tau = data['tau']
    return angle,angle_t,angle_tt,tau
