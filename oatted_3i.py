...
if environment == 'laptop':
    ...
    params['root_dir'] = R'./progress/angle_tt'
params['learning_rate'] = 1e-11
params['switching_epochs'] = 800
params['learning_rate_2'] = 1e-11
# save parameters
params['if_save'] = True
...
for epoch in range(params['epochs']):
    ...
    for i in range(len(data['z'])//params['batch_size']):
        ...
        for j in range(image_temp.shape[0]-2):
            ...
            loss_angle = torch.abs(angle_tt_true[0] - pre[0]) + torch.abs(angle_tt_true[1]-pre[1])
