...
def img_save(n_ics,params):
    ...
    for i in range(500):
        image = Image.fromarray(x[i,:,:]*255)
        file_name = str('{}.jpg'.format(i))
        print(file_name)
        PATH = os.path.join(r'C:\Users\87106\OneDrive\sindy\github\Autoencoder-conservtive_expression\pendulum_example\double',file_name)
        image.save(PATH,'JEPG')
    return
